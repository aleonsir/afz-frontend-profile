 ...
 */
if (!class_exists('AFZFP_Captcha_Recaptcha')) {
    /**
     * Captcha Recaptcha class.
     */
    class AFZFP_Captcha_Recaptcha
    {
        /**
         * Captcha Recaptcha class.
         *
        ...
        {
            self::$site_key = afzfp_get_option('recaptcha_public', 'afzfp_general');

            self::$secret_key = afzfp_get_option('recaptcha_private', 'afzfp_general');

            self::$script_handle = 'afzfp-recaptcha';

            add_action('plugins_loaded', [__CLASS__, 'load_plugin_textdomain']);

            // initialize if login is activated.
            if ((afzfp_get_option('enable_captcha_login', 'afzfp_general') === 'on') || (afzfp_get_option('enable_captcha_registration', 'afzfp_general') === 'on')) {
        ...
        public static function enqueue_header_script()
        {
            ...
            wp_enqueue_script(self::$script_handle, $src, false, 1, true);
            wp_enqueue_script('afzfp_google_recaptcha', 'https://www.google.com/recaptcha/api.js', false, 1, false);
        }
